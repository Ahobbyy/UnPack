...
public static class SteamAchievementMap
{
	...
	public static void ValidateMaps()
	{
		...
		for (int i = 0; i < values.Length; i++)
		{
			...
			{
				Debug.LogErrorFormat("Mapping for stat {0} not defined", new object[1] { stat });
			}
		}
		...
		for (int j = 0; j < values2.Length; j++)
		{
			...
			{
				Debug.LogErrorFormat("Mapping for achievement {0} not defined", new object[1] { achievement });
			}
			else
			{
	...
	{
		if (achievementMapInv.TryGetValue(achievement, out var value))
		{
			return value;
		}
		return null;
	...
	{
		if (achievementMap.TryGetValue(id, out var value))
		{
			return value;
		}
	...
	{
		if (statsMap.TryGetValue(id, out var value))
		{
			return value;
		}
