...
public class SkiLiftAchievement : MonoBehaviour
{
	...
	private void Start()
	{
		waypoints = ((Component)this).GetComponent<FollowWaypoints>();
	...
	{
		int num = this.humanData.FindIndex((HumanData hd) => (Object)(object)hd.human == (Object)(object)h);
		if (num < 0)
		{
	...
	{
		int num = humanData.FindIndex((HumanData hd) => (Object)(object)hd.human == (Object)(object)h);
		if (num >= 0)
		{
