...
public class ConfirmMenu : MenuTransition
{
	...
	{
		titleText.text = (title.Contains("/") ? ScriptLocalization.Get(title) : title);
		descriptionText.text = (description.Contains("/") ? ScriptLocalization.Get(description) : description);
