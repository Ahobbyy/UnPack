...
public static class Dialogs
{
	...
	{
		DialogOverlay.Show(1f, showProgress: true, T("MULTIPLAYER/CONNECTING.Title"), null, (onCancel != null) ? T("MULTIPLAYER/CONNECTING.CANCEL") : null, onCancel);
	}
	...
	{
		if ((Object)(object)previousMenuItemToFocus != (Object)null)
		{
			EventSystem.get_current().SetSelectedGameObject(previousMenuItemToFocus);
		}
	...
	{
		error = ((!string.IsNullOrEmpty(error)) ? ErrorToString(error) : "");
