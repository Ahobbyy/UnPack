...
public class StartupExperienceUI : MonoBehaviour, IDependency
{
	...
	private void Start()
	{
		pressPrompt.text = ScriptLocalization.Get(ControllerAvailable ? controllerStartTerm : keybaordStartTerm);
		...
		writtenByLabel.font = (flag ? writtenByFont : menuSDFFont);
		writtenByLabel.text = text;
	}

	public StartupExperienceUI()
		: this()
	{
	}
}
