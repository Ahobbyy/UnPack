	...
	public sealed class AmbientOcclusion : PostProcessEffectSettings
	{
		...
		public override bool IsEnabledAndSupported(PostProcessRenderContext context)
		{
			...
			if (mode.value == AmbientOcclusionMode.ScalableAmbientObscurance)
			{
				...
				if (context != null)
				{
					flag &= Object.op_Implicit((Object)(object)context.resources.shaders.scalableAO) && context.resources.shaders.scalableAO.get_isSupported();
				}
			}
			else if (mode.value == AmbientOcclusionMode.MultiScaleVolumetricObscurance)
			{
				if (context != null)
				{
					flag &= Object.op_Implicit((Object)(object)context.resources.shaders.multiScaleAO) && context.resources.shaders.multiScaleAO.get_isSupported() && Object.op_Implicit((Object)(object)context.resources.computeShaders.multiScaleAODownsample1) && Object.op_Implicit((Object)(object)context.resources.computeShaders.multiScaleAODownsample2) && Object.op_Implicit((Object)(object)context.resources.computeShaders.multiScaleAORender) && Object.op_Implicit((Object)(object)context.resources.computeShaders.multiScaleAOUpsample);
				}
				flag &= SystemInfo.get_supportsComputeShaders() && !RuntimeUtilities.isAndroidOpenGL && ((RenderTextureFormat)14).IsSupported() && ((RenderTextureFormat)15).IsSupported() && ((RenderTextureFormat)16).IsSupported();
			}
			return flag;
		}
	}
