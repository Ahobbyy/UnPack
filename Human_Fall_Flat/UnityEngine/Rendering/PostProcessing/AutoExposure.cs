...
namespace UnityEngine.Rendering.PostProcessing
{
	...
	public sealed class AutoExposure : PostProcessEffectSettings
	{
		...
		{
			if (enabled.value && SystemInfo.get_supportsComputeShaders() && !RuntimeUtilities.isAndroidOpenGL && ((RenderTextureFormat)14).IsSupported() && Object.op_Implicit((Object)(object)context.resources.computeShaders.autoExposure))
			{
