...
public abstract class ProportionalServoMotor : MonoBehaviour, IReset
{
	...
	protected virtual void OnEnable()
	{
		...
		Debug.LogError((object)"ProportionalServoMotor", (Object)(object)((Component)this).get_gameObject());
	...
	private void FixedUpdate()
	{
		...
		float num = (((Object)(object)powerSignal != (Object)null) ? (powerSignal.value / neededVoltage) : 1f);
		...
		else
		{
			...
			velocity = Mathf.MoveTowards(velocity, num2, maxVelocity * Time.get_fixedDeltaTime() / timeToAccelerate);
		}
		if (velocity != 0f)
		{
			...
			targetValue = Mathf.Clamp(targetValue + velocity * Time.get_fixedDeltaTime(), minValue, maxValue);
			if (targetValue == num3)
			{
				timeStopped += Time.get_fixedDeltaTime();
			...
			if ((Object)(object)sound != (Object)null)
			{
				sound.SetPitch(((velocity > 0f) ? pitchPositive : pitchNegative) * ((targetValue == num3) ? pitchLimit : 1f));
			}
			else if ((Object)(object)servoSound != (Object)null)
			{
				servoSound.SetPitch(((velocity > 0f) ? pitchPositive : pitchNegative) * ((targetValue == num3) ? pitchLimit : 1f));
			}
			TargetValueChanged(targetValue);
		}
		else if ((Object)(object)sound != (Object)null)
		{
			if (sound.isPlaying)
			{
				sound.Stop();
	...
	protected ProportionalServoMotor()
		: this()
	{
	}
}
