		...
		public TMP_MeshInfo[] CopyMeshInfoVertexData()
		{
			if (m_CachedMeshInfo == null || m_CachedMeshInfo.Length != meshInfo.Length)
			{
				...
				for (int i = 0; i < m_CachedMeshInfo.Length; i++)
				{
					...
					m_CachedMeshInfo[i].vertices = (Vector3[])(object)new Vector3[num];
					m_CachedMeshInfo[i].uvs0 = (Vector2[])(object)new Vector2[num];
					m_CachedMeshInfo[i].uvs2 = (Vector2[])(object)new Vector2[num];
					m_CachedMeshInfo[i].colors32 = (Color32[])(object)new Color32[num];
				}
			}
			for (int j = 0; j < m_CachedMeshInfo.Length; j++)
			{
				...
				{
					m_CachedMeshInfo[j].vertices = (Vector3[])(object)new Vector3[num2];
					m_CachedMeshInfo[j].uvs0 = (Vector2[])(object)new Vector2[num2];
					m_CachedMeshInfo[j].uvs2 = (Vector2[])(object)new Vector2[num2];
					m_CachedMeshInfo[j].colors32 = (Color32[])(object)new Color32[num2];
				}
