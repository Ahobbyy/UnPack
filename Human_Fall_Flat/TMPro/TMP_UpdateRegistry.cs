...
namespace TMPro
{
	public class TMP_UpdateRegistry
	{
		...
		protected TMP_UpdateRegistry()
		{
			...
			Canvas.add_willRenderCanvases(new WillRenderCanvases(PerformUpdateForCanvasRendererObjects));
		}
		...
		{
			int instanceID = ((Object)((element is Object) ? element : null)).GetInstanceID();
		...
		private void PerformUpdateForCanvasRendererObjects()
		{
			...
			{
				instance.m_LayoutRebuildQueue[i].Rebuild((CanvasUpdate)0);
			}
			...
			{
				instance.m_GraphicRebuildQueue[j].Rebuild((CanvasUpdate)3);
			}
