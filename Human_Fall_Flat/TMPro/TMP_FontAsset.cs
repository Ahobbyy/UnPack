...
namespace TMPro
{
	...
	public class TMP_FontAsset : TMP_Asset
	{
		...
		public static TMP_FontAsset defaultFontAsset
		{
			get
			{
				if ((Object)(object)s_defaultFontAsset == (Object)null)
				{
		...
		public void ReadFontDefinition()
		{
			...
			hashCode = TMP_TextUtilities.GetSimpleHashCode(((Object)this).get_name());
			materialHashCode = TMP_TextUtilities.GetSimpleHashCode(((Object)material).get_name());
		}
		...
		public bool HasCharacter(char character, bool searchFallbacks)
		{
			...
			if (searchFallbacks)
			{
				...
				{
					for (int i = 0; i < fallbackFontAssets.Count && (Object)(object)fallbackFontAssets[i] != (Object)null; i++)
					{
				...
				{
					for (int j = 0; j < TMP_Settings.fallbackFontAssets.Count && (Object)(object)TMP_Settings.fallbackFontAssets[j] != (Object)null; j++)
					{
