...
public static class DebugExtension
{
	public static void DebugPoint(Vector3 position, Color color, float scale = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		color = ((color == default(Color)) ? Color.get_white() : color);
		Debug.DrawRay(position + Vector3.get_up() * (scale * 0.5f), -Vector3.get_up() * scale, color, duration, depthTest);
		Debug.DrawRay(position + Vector3.get_right() * (scale * 0.5f), -Vector3.get_right() * scale, color, duration, depthTest);
		Debug.DrawRay(position + Vector3.get_forward() * (scale * 0.5f), -Vector3.get_forward() * scale, color, duration, depthTest);
	}
	...
	public static void DebugPoint(Vector3 position, float scale = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		DebugPoint(position, Color.get_white(), scale, duration, depthTest);
	}
	...
	public static void DebugBounds(Bounds bounds, Color color, float duration = 0f, bool depthTest = true)
	{
		...
		float y = ((Bounds)(ref bounds)).get_extents().y;
		float z = ((Bounds)(ref bounds)).get_extents().z;
	...
	public static void DebugBounds(Bounds bounds, float duration = 0f, bool depthTest = true)
	{
		//IL_0000: Unknown result type (might be due to invalid IL or missing references)
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		DebugBounds(bounds, Color.get_white(), duration, depthTest);
	}
	...
	public static void DebugLocalCube(Transform transform, Vector3 size, Vector3 center = default(Vector3), float duration = 0f, bool depthTest = true)
	{
		...
		DebugLocalCube(transform, size, Color.get_white(), center, duration, depthTest);
	}
	...
	public static void DebugLocalCube(Matrix4x4 space, Vector3 size, Vector3 center = default(Vector3), float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		DebugLocalCube(space, size, Color.get_white(), center, duration, depthTest);
	}
	...
	public static void DebugCircle(Vector3 position, Vector3 up, Color color, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_016f: Unknown result type (might be due to invalid IL or missing references)
		Vector3 val = ((Vector3)(ref up)).get_normalized() * radius;
		Vector3 val2 = Vector3.Slerp(val, -val, 0.5f);
		Vector3 val3 = Vector3.Cross(val, val2);
		Vector3 val4 = ((Vector3)(ref val3)).get_normalized() * radius;
		Matrix4x4 val5 = default(Matrix4x4);
		((Matrix4x4)(ref val5)).set_Item(0, val4.x);
		((Matrix4x4)(ref val5)).set_Item(1, val4.y);
		((Matrix4x4)(ref val5)).set_Item(2, val4.z);
		((Matrix4x4)(ref val5)).set_Item(4, val.x);
		((Matrix4x4)(ref val5)).set_Item(5, val.y);
		((Matrix4x4)(ref val5)).set_Item(6, val.z);
		((Matrix4x4)(ref val5)).set_Item(8, val2.x);
		((Matrix4x4)(ref val5)).set_Item(9, val2.y);
		((Matrix4x4)(ref val5)).set_Item(10, val2.z);
		Vector3 val6 = position + ((Matrix4x4)(ref val5)).MultiplyPoint3x4(new Vector3(Mathf.Cos(0f), 0f, Mathf.Sin(0f)));
		Vector3 val7 = Vector3.get_zero();
		color = ((color == default(Color)) ? Color.get_white() : color);
		for (int i = 0; i < 91; i++)
		{
	...
	public static void DebugCircle(Vector3 position, Color color, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		DebugCircle(position, Vector3.get_up(), color, radius, duration, depthTest);
	}
	...
	public static void DebugCircle(Vector3 position, Vector3 up, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DebugCircle(position, up, Color.get_white(), radius, duration, depthTest);
	}
	...
	public static void DebugCircle(Vector3 position, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DebugCircle(position, Vector3.get_up(), Color.get_white(), radius, duration, depthTest);
	}
	...
	public static void DebugWireSphere(Vector3 position, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		//IL_0000: Unknown result type (might be due to invalid IL or missing references)
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		DebugWireSphere(position, Color.get_white(), radius, duration, depthTest);
	}
	...
	public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		Vector3 val2 = ((Vector3)(ref val)).get_normalized() * radius;
		Vector3 val3 = Vector3.Slerp(val2, -val2, 0.5f);
		val = Vector3.Cross(val2, val3);
		Vector3 val4 = ((Vector3)(ref val)).get_normalized() * radius;
	...
	public static void DebugCylinder(Vector3 start, Vector3 end, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DebugCylinder(start, end, Color.get_white(), radius, duration, depthTest);
	}
	...
	public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45f, float duration = 0f, bool depthTest = true)
	{
		...
		float magnitude = ((Vector3)(ref direction)).get_magnitude();
		Vector3 val = direction;
		Vector3 val2 = Vector3.Slerp(val, -val, 0.5f);
		Vector3 val3 = Vector3.Cross(val, val2);
		Vector3 val4 = ((Vector3)(ref val3)).get_normalized() * magnitude;
		direction = ((Vector3)(ref direction)).get_normalized();
		...
		Debug.DrawRay(position, ((Vector3)(ref val5)).get_normalized() * num, color);
		val3 = Vector3.Slerp(val, -val2, angle / 90f);
		Debug.DrawRay(position, ((Vector3)(ref val3)).get_normalized() * num, color, duration, depthTest);
		...
		val3 = val - ((Vector3)(ref val5)).get_normalized() * num;
		DebugCircle(position2, up, color, ((Vector3)(ref val3)).get_magnitude(), duration, depthTest);
		Vector3 position3 = position + val * 0.5f;
		Vector3 up2 = direction;
		val3 = val * 0.5f - ((Vector3)(ref val5)).get_normalized() * (num * 0.5f);
		DebugCircle(position3, up2, color, ((Vector3)(ref val3)).get_magnitude(), duration, depthTest);
	}
	...
	public static void DebugCone(Vector3 position, Vector3 direction, float angle = 45f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DebugCone(position, direction, Color.get_white(), angle, duration, depthTest);
	}
	...
	public static void DebugCone(Vector3 position, Color color, float angle = 45f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DebugCone(position, Vector3.get_up(), color, angle, duration, depthTest);
	}
	...
	public static void DebugCone(Vector3 position, float angle = 45f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DebugCone(position, Vector3.get_up(), Color.get_white(), angle, duration, depthTest);
	}
	...
	public static void DebugArrow(Vector3 position, Vector3 direction, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DebugArrow(position, direction, Color.get_white(), duration, depthTest);
	}
	...
	public static void DebugCapsule(Vector3 start, Vector3 end, Color color, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		val = start - val5;
		start = val5 + ((Vector3)(ref val)).get_normalized() * num;
		val = end - val5;
		end = val5 + ((Vector3)(ref val)).get_normalized() * num;
		DebugCircle(start, val2, color, radius, duration, depthTest);
		DebugCircle(end, -val2, color, radius, duration, depthTest);
		Debug.DrawLine(start + val4, end + val4, color, duration, depthTest);
		Debug.DrawLine(start - val4, end - val4, color, duration, depthTest);
	...
	public static void DebugCapsule(Vector3 start, Vector3 end, float radius = 1f, float duration = 0f, bool depthTest = true)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DebugCapsule(start, end, Color.get_white(), radius, duration, depthTest);
	}
	...
	public static void DrawPoint(Vector3 position, Color color, float scale = 1f)
	{
		...
		Gizmos.DrawRay(position + Vector3.get_up() * (scale * 0.5f), -Vector3.get_up() * scale);
		Gizmos.DrawRay(position + Vector3.get_right() * (scale * 0.5f), -Vector3.get_right() * scale);
		Gizmos.DrawRay(position + Vector3.get_forward() * (scale * 0.5f), -Vector3.get_forward() * scale);
	...
	public static void DrawPoint(Vector3 position, float scale = 1f)
	{
		//IL_0000: Unknown result type (might be due to invalid IL or missing references)
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		DrawPoint(position, Color.get_white(), scale);
	}
	...
	public static void DrawBounds(Bounds bounds)
	{
		//IL_0000: Unknown result type (might be due to invalid IL or missing references)
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		DrawBounds(bounds, Color.get_white());
	}
	...
	public static void DrawLocalCube(Transform transform, Vector3 size, Vector3 center = default(Vector3))
	{
		...
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		DrawLocalCube(transform, size, Color.get_white(), center);
	}
	...
	public static void DrawLocalCube(Matrix4x4 space, Vector3 size, Vector3 center = default(Vector3))
	{
		...
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		DrawLocalCube(space, size, Color.get_white(), center);
	}
	...
	public static void DrawCircle(Vector3 position, Vector3 up, Color color, float radius = 1f)
	{
		...
		//IL_018a: Unknown result type (might be due to invalid IL or missing references)
		//IL_0197: Unknown result type (might be due to invalid IL or missing references)
		Vector3 val = ((up == Vector3.get_zero()) ? Vector3.get_up() : up);
		up = ((Vector3)(ref val)).get_normalized() * radius;
		Vector3 val2 = Vector3.Slerp(up, -up, 0.5f);
		val = Vector3.Cross(up, val2);
		Vector3 val3 = ((Vector3)(ref val)).get_normalized() * radius;
		Matrix4x4 val4 = default(Matrix4x4);
		((Matrix4x4)(ref val4)).set_Item(0, val3.x);
		((Matrix4x4)(ref val4)).set_Item(1, val3.y);
		((Matrix4x4)(ref val4)).set_Item(2, val3.z);
		((Matrix4x4)(ref val4)).set_Item(4, up.x);
		((Matrix4x4)(ref val4)).set_Item(5, up.y);
		((Matrix4x4)(ref val4)).set_Item(6, up.z);
		((Matrix4x4)(ref val4)).set_Item(8, val2.x);
		((Matrix4x4)(ref val4)).set_Item(9, val2.y);
		((Matrix4x4)(ref val4)).set_Item(10, val2.z);
		Vector3 val5 = position + ((Matrix4x4)(ref val4)).MultiplyPoint3x4(new Vector3(Mathf.Cos(0f), 0f, Mathf.Sin(0f)));
		Vector3 val6 = Vector3.get_zero();
		Color color2 = Gizmos.get_color();
		Gizmos.set_color((color == default(Color)) ? Color.get_white() : color);
		for (int i = 0; i < 91; i++)
		{
			val6.x = Mathf.Cos((float)(i * 4) * ((float)Math.PI / 180f));
			val6.z = Mathf.Sin((float)(i * 4) * ((float)Math.PI / 180f));
			val6.y = 0f;
			val6 = position + ((Matrix4x4)(ref val4)).MultiplyPoint3x4(val6);
			Gizmos.DrawLine(val5, val6);
			val5 = val6;
		}
		Gizmos.set_color(color2);
	...
	public static void DrawCircle(Vector3 position, Color color, float radius = 1f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DrawCircle(position, Vector3.get_up(), color, radius);
	}
	...
	public static void DrawCircle(Vector3 position, Vector3 up, float radius = 1f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DrawCircle(position, position, Color.get_white(), radius);
	}
	...
	public static void DrawCircle(Vector3 position, float radius = 1f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DrawCircle(position, Vector3.get_up(), Color.get_white(), radius);
	}
	...
	public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1f)
	{
		...
		Gizmos.DrawLine(start - val3, end - val3);
		Gizmos.DrawLine(start - val4, start + val4);
		Gizmos.DrawLine(start - val3, start + val3);
		Gizmos.DrawLine(end - val4, end + val4);
	...
	public static void DrawCylinder(Vector3 start, Vector3 end, float radius = 1f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DrawCylinder(start, end, Color.get_white(), radius);
	}
	...
	public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45f)
	{
		...
		Color color2 = Gizmos.get_color();
		Gizmos.set_color(color);
		Gizmos.DrawRay(position, ((Vector3)(ref val5)).get_normalized() * num);
		val3 = Vector3.Slerp(val, -val2, angle / 90f);
		Gizmos.DrawRay(position, ((Vector3)(ref val3)).get_normalized() * num);
		val3 = Vector3.Slerp(val, val4, angle / 90f);
		Gizmos.DrawRay(position, ((Vector3)(ref val3)).get_normalized() * num);
		val3 = Vector3.Slerp(val, -val4, angle / 90f);
		Gizmos.DrawRay(position, ((Vector3)(ref val3)).get_normalized() * num);
		...
		Vector3 up = direction;
		val3 = val - ((Vector3)(ref val5)).get_normalized() * num;
		DrawCircle(position2, up, color, ((Vector3)(ref val3)).get_magnitude());
		Vector3 position3 = position + val * 0.5f;
		Vector3 up2 = direction;
		val3 = val * 0.5f - ((Vector3)(ref val5)).get_normalized() * (num * 0.5f);
		DrawCircle(position3, up2, color, ((Vector3)(ref val3)).get_magnitude());
		Gizmos.set_color(color2);
	}
	...
	public static void DrawCone(Vector3 position, Vector3 direction, float angle = 45f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DrawCone(position, direction, Color.get_white(), angle);
	}
	...
	public static void DrawCone(Vector3 position, Color color, float angle = 45f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DrawCone(position, Vector3.get_up(), color, angle);
	}
	...
	public static void DrawCone(Vector3 position, float angle = 45f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		DrawCone(position, Vector3.get_up(), Color.get_white(), angle);
	}
	...
	public static void DrawArrow(Vector3 position, Vector3 direction)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DrawArrow(position, direction, Color.get_white());
	}
	...
	public static void DrawCapsule(Vector3 start, Vector3 end, Color color, float radius = 1f)
	{
		...
		for (int i = 1; i < 26; i++)
		{
			Gizmos.DrawLine(Vector3.Slerp(val4, -val2, (float)i / 25f) + start, Vector3.Slerp(val4, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(-val4, -val2, (float)i / 25f) + start, Vector3.Slerp(-val4, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(val3, -val2, (float)i / 25f) + start, Vector3.Slerp(val3, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(-val3, -val2, (float)i / 25f) + start, Vector3.Slerp(-val3, -val2, (float)(i - 1) / 25f) + start);
			Gizmos.DrawLine(Vector3.Slerp(val4, val2, (float)i / 25f) + end, Vector3.Slerp(val4, val2, (float)(i - 1) / 25f) + end);
			Gizmos.DrawLine(Vector3.Slerp(-val4, val2, (float)i / 25f) + end, Vector3.Slerp(-val4, val2, (float)(i - 1) / 25f) + end);
	...
	public static void DrawCapsule(Vector3 start, Vector3 end, float radius = 1f)
	{
		...
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0002: Unknown result type (might be due to invalid IL or missing references)
		DrawCapsule(start, end, Color.get_white(), radius);
	}
