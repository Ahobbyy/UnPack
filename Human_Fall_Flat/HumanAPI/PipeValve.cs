...
namespace HumanAPI
{
	public class PipeValve : Node
	{
		...
		private void Awake()
		{
			port1 = ((Component)node1).get_gameObject().AddComponent<PipeValvePort>();
			port1.node = node1;
			port2 = ((Component)node2).get_gameObject().AddComponent<PipeValvePort>();
			port2.node = node2;
		...
		public override void Process()
		{
			...
			{
				if ((Object)(object)port1.connectedPort == (Object)null)
				{
			...
			else if ((Object)(object)port1.connectedPort != (Object)null)
			{
