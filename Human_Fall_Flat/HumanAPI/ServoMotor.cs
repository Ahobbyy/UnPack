...
namespace HumanAPI
{
	public class ServoMotor : Node, INetBehavior
	{
		...
		private void FixedUpdate()
		{
			...
			if ((Object)(object)joint != (Object)null)
			{
				...
				if (mode == ServoMode.Position)
				{
					...
					speed = Mathf.MoveTowards(speed, Mathf.Sign(num4 - num) * joint.maxSpeed, joint.maxAcceleration * Time.get_fixedDeltaTime());
		...
		public void ResetMotorState()
		{
			if (showDebug)
			{
				Debug.Log((object)(((Object)this).get_name() + " Resetting the state of reached end "));
			}
			reachedEnd = 0f;
		}
