...
namespace HumanAPI
{
	public static class Circuit
	{
		private static bool IsCircuitClosed(CircuitConnector from)
		{
			...
			while ((Object)(object)circuitConnector != (Object)(object)from && (Object)(object)circuitConnector != (Object)null);
			if ((Object)(object)circuitConnector == (Object)null)
			{
				return false;
			}
			return true;
		...
		{
			if ((Object)(object)c1.connected != (Object)null)
			{
				Debug.LogError((object)"Connector already in use", (Object)(object)c1);
				return false;
			}
			if ((Object)(object)c2.connected != (Object)null)
			{
				Debug.LogError((object)"Connector already in use", (Object)(object)c2);
				return false;
			}
			c1.connected = c2;
			c2.connected = c1;
		...
		public static void Disconnect(CircuitConnector c1)
		{
			if ((Object)(object)c1.connected == (Object)null)
			{
				Debug.LogError((object)"Connector not connected", (Object)(object)c1);
				return;
			}
			if ((Object)(object)c1.connected.connected == (Object)null)
			{
				Debug.LogError((object)"Connector not connected", (Object)(object)c1.connected);
				return;
			}
			StopCurrent(c1);
