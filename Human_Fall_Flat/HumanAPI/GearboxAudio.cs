...
namespace HumanAPI
{
	public class GearboxAudio : MonoBehaviour, IReset, INetBehavior
	{
		...
		public void SetGet(int gear)
		{
			...
			if (gear < 0)
			{
				if ((Object)(object)gearReverse != (Object)null)
				{
					gearReverse.PlayOneShot();
				}
			}
			else if ((Object)(object)gearShift != (Object)null)
			{
				gearShift.PlayOneShot();
			}
			if (!((Object)(object)reverseBeep != (Object)null))
			{
				return;
			}
			if (gear == -1)
		...
		private void Update()
		{
			...
			if (GrabManager.IsGrabbedAny(((Component)lever).get_gameObject()) != leverGrabbed)
			{
				if (!leverGrabbed)
				{
					GrabLever();
		...
		public void CalculateDelta(NetStream state0, NetStream state1, NetStream delta)
		{
			...
			uint num = ((state0 != null) ? (state0.ReadUInt32(2) - 1) : 0);
			bool flag2 = state1.ReadBool();
			int num2 = (int)(state1.ReadUInt32(2) - 1);
			if (num != (uint)num2 || flag != flag2)
			{
				delta.Write(v: true);
				delta.Write(flag2);
