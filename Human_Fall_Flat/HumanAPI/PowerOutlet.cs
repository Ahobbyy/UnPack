	...
	public class PowerOutlet : Node, ICircuitComponent
	{
		...
		public CircuitConnector forwardConnector
		{
			get
			{
				if (showDebug)
				{
					Debug.Log((object)(((Object)this).get_name() + " Forward Connector "));
				}
				return plus;
			}
		}
		...
		public CircuitConnector reverseConnector
		{
			get
			{
				if (showDebug)
				{
					Debug.Log((object)(((Object)this).get_name() + " Reverse Connector "));
				}
				return minus;
			}
		}
		...
		public bool isOpen
		{
			get
			{
				if (showDebug)
				{
					Debug.Log((object)(((Object)this).get_name() + " Is Open "));
				}
				return false;
			}
		}
		...
		public virtual float CalculateVoltage(float I)
		{
			if (showDebug)
			{
				Debug.Log((object)(((Object)this).get_name() + " Calculate Voltage "));
			}
			if (I > maxI)
			{
		...
		public virtual void RunCurrent(float I)
		{
			if (showDebug)
			{
				Debug.Log((object)(((Object)this).get_name() + " Run Current "));
			}
			current = I;
		}
		...
		public virtual void StopCurrent()
		{
			if (showDebug)
			{
				Debug.Log((object)(((Object)this).get_name() + " Stop Current "));
			}
			current = 0f;
		}
