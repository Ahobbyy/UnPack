	...
	public class WorkshopItemMetadata
	{
		...
		public Texture2D thumbnailTexture
		{
			get
			{
				...
				if ((Object)(object)cachedThumbnail == (Object)null)
				{
					bool isAsset;
		...
		{
			FileTools.WriteJson(FileTools.Combine(folder, "metadata.json"), this);
		}

		public static WorkshopItemMetadata Load(string folder)
		{
			string text = FileTools.ReadAllText(FileTools.Combine(folder, "metadata.json"));
			if (text == null)
			{
				return null;
			}
		...
		{
			thumbnailRefCount--;
			if (thumbnailRefCount == 0 && (Object)(object)cachedThumbnail != (Object)null)
			{
				Object.Destroy((Object)(object)cachedThumbnail);
		...
		public void Reload()
		{
			...
			if (text != null)
			{
				JsonUtility.FromJsonOverwrite(text, (object)this);
			}
		}
	}
}
