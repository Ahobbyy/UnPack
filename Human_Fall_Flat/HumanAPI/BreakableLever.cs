	...
	public class BreakableLever : Lever, INetBehavior
	{
		...
		private void Break()
		{
			if (angularJoint.jointCreated)
			{
				...
				((Component)angularJoint.body).get_gameObject().GetComponent<CGShift>().ResetCG();
				if ((Object)(object)breakSound != (Object)null)
				{
					breakSound.PlayOneShot();
				}
				if ((Object)(object)audioSourceBreakSound != (Object)null)
				{
