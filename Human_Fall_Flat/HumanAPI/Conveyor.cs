...
namespace HumanAPI
{
	...
	public class Conveyor : Node, INetBehavior
	{
		...
		{
			if (!topGrabbable && GrabManager.IsGrabbedAny(((Component)topTrack).get_gameObject()))
			{
				GrabManager.Release(((Component)topTrack).get_gameObject(), 1f);
			}
			if (!bottomGrabbable && GrabManager.IsGrabbedAny(((Component)bottomTrack).get_gameObject()))
			{
				GrabManager.Release(((Component)bottomTrack).get_gameObject(), 1f);
			}
			if (!startGrabbable && GrabManager.IsGrabbedAny(((Component)startTrack).get_gameObject()))
			{
				GrabManager.Release(((Component)startTrack).get_gameObject(), 1f);
			}
			if (!endGrabbable && GrabManager.IsGrabbedAny(((Component)endTrack).get_gameObject()))
			{
				GrabManager.Release(((Component)endTrack).get_gameObject(), 1f);
			}
			if (!ReplayRecorder.isPlaying && !NetGame.isClient && input.value != 0f && !((Object)(object)topTrack == (Object)null))
			{
				AdvanceArrays(input.value * speed * Time.get_fixedDeltaTime());
			}
		}
		...
		private void InitializeArrays()
		{
			...
			if (!topGrabbable)
			{
				((Component)topTrack).get_gameObject().set_tag("NoGrab");
				((Component)topTrack).get_gameObject().set_layer(LayerMask.NameToLayer("NoGrab"));
			}
			...
			if (!endGrabbable)
			{
				((Component)endTrack).get_gameObject().set_tag("NoGrab");
				((Component)endTrack).get_gameObject().set_layer(LayerMask.NameToLayer("NoGrab"));
			}
			...
			if (!bottomGrabbable)
			{
				((Component)bottomTrack).get_gameObject().set_tag("NoGrab");
				((Component)bottomTrack).get_gameObject().set_layer(LayerMask.NameToLayer("NoGrab"));
			}
			...
			if (!startGrabbable)
			{
				((Component)startTrack).get_gameObject().set_tag("NoGrab");
				((Component)startTrack).get_gameObject().set_layer(LayerMask.NameToLayer("NoGrab"));
			}
		...
		private void AdvanceArrays(float delta)
		{
			...
			{
				((Component)topTrack).get_transform().set_position(((Component)this).get_transform().get_position() + axisForward * currentOffset);
				((Component)bottomTrack).get_transform().set_position(((Component)this).get_transform().get_position() + axisForward * (length - currentOffset));
			}
			else
			{
			...
			if (ReplayRecorder.isPlaying || NetGame.isClient)
			{
				((Component)startTrack).get_transform().set_rotation(((Component)this).get_transform().get_rotation() * Quaternion.AngleAxis(num2 / radialLength * 180f + 180f, right));
				((Component)endTrack).get_transform().set_rotation(((Component)this).get_transform().get_rotation() * Quaternion.AngleAxis(num2 / radialLength * 180f, right));
			}
			else
			{
