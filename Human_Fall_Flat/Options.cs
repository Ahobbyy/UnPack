...
public static class Options
{
	...
	public static ulong multiplayerLobbyLevelStore
	{
		get
		{
			...
			long num = (long)PlayerPrefs.GetInt("multiplayerLobbyLevelH", 0) << 32;
	...
	public static void ApplyAdvancedVideo()
	{
		...
		QualitySettings.set_vSyncCount(advancedVideoVsync);
		QualitySettings.set_masterTextureLimit((advancedVideoTexture == 0) ? 1 : 0);
		QualitySettings.set_anisotropicFiltering((AnisotropicFiltering)((advancedVideoTexture > 1) ? 1 : 0));
		if ((Object)(object)CloudSystem.instance != (Object)null)
		{
	...
	{
		if ((Object)(object)GameAudio.instance != (Object)null)
		{
	...
	{
		if ((Object)(object)SubtitleManager.instance != (Object)null)
		{
	...
	{
		if (Object.op_Implicit((Object)(object)MusicManager.instance))
		{
	...
	{
		float num = Mathf.Log((targetCenter - targetFrom) / (targetTo - targetFrom), 0.5f);
		return Mathf.Lerp(targetFrom, targetTo, Mathf.Pow(Mathf.InverseLerp(sourceLow, sourceHigh, value), num));
	}
	...
	{
		float num = (sourceMid - sourceLow) / (sourceHigh - sourceLow);
		float num2 = Mathf.Log((targetCenter - targetFrom) / (targetTo - targetFrom), num);
		return Mathf.Lerp(targetFrom, targetTo, Mathf.Pow(Mathf.InverseLerp(sourceLow, sourceHigh, value), num2));
	}
	...
	{
		if (Object.op_Implicit((Object)(object)PlayerManager.instance))
		{
			PlayerManager.instance.ApplyControls();
		}
	}
	...
	public static void LoadKeyboardBindings()
	{
		...
		{
			PlayerPrefs.GetString("Bindings");
		}
	}
