...
public class ProceduralDroneMix : MonoBehaviour
{
	...
	{
		if ((Object)(object)mainsound == (Object)null || mainsound.activeClip == null || (Object)(object)mainsound.activeClip.clip == (Object)null)
		{
			Duck(1f);
		}
		else
		{
			Duck(mainsound.activeClip.clip.get_length());
		}
	}
	...
	private void Awake()
	{
		Sound2[] componentsInChildren = ((Component)this).GetComponentsInChildren<Sound2>();
	...
	public void Update()
	{
		...
		time += Time.get_unscaledDeltaTime();
		if (nextEvent < time)
		{
		...
		masterPhase += masterPhaseSpeed * Time.get_unscaledDeltaTime();
		ApplyMasterVolume();
	...
	private void ApplyMasterVolume()
	{
		...
		unduckAfter -= Time.get_unscaledDeltaTime();
		if (unduckAfter <= 0f)
		{
			duckPhaseSpeed = 1f / duckIn;
		}
		duckPhase += duckPhaseSpeed * Time.get_unscaledDeltaTime();
