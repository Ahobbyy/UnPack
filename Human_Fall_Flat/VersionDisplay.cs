...
public class VersionDisplay : MonoBehaviour
{
	...
	public static uint netCode = 21u;
	...
	private void Start()
	{
		...
		TextAsset obj = Resources.Load<TextAsset>("Curve/build_version_number");
		XmlSerializer xmlSerializer = new XmlSerializer(versionNumber.GetType());
		StringReader textReader = new StringReader(obj.get_text());
		...
		((Component)this).GetComponent<RectTransform>().SetSizeWithCurrentAnchors((Axis)0, 700f);
